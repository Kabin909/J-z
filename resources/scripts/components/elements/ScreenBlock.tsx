    ...
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            ...
            >
                ...
                <img src={'/images/jz-logo.png'} alt={'J&Z Panel'} css={tw`w-28 h-28 object-contain select-none mx-auto mb-3`} />
                <img src={image} alt={title} css={tw`w-2/3 h-auto select-none mx-auto`} />
